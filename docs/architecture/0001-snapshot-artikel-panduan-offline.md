...
Mobile menampilkan Artikel Panduan dari Room dan mengganti seluruh cache secara atomik setelah berhasil mengambil snapshot lengkap artikel aktif; snapshot bawaan APK dipakai hanya sebelum sync pernah berhasil dilakukan. Pendekatan ini dipilih daripada request per artikel atau cache parsial karena daftar dan detail harus konsisten saat offline, penonaktifan harus dapat menarik konten pada sync berikutnya, dan kegagalan jaringan tidak boleh merusak salinan terakhir yang valid.
